...
insert into pit (competition_id, team_id, status) values (1, 6, 'Started');
insert into pit (competition_id, team_id, status) values (1, 7, 'Started');
insert into pit (competition_id, team_id, status) values (1, 11, 'Started');
insert into pit (competition_id, team_id, status) values (1, 12, 'Started');
insert into pit (competition_id, team_id, status) values (1, 21, 'Started');
